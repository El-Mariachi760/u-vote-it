...
VALUES
  ('Protectors of Auir', 'The Protectors of Auir eat, breathe, and sleep JavaScript. They can build everything you could ever want in JS, including a new kitchen sink.'),
  ('Brotherhood of Steel', 'Want to see a mock-up turn into an actual webpage in a matter of minutes? Well, the BoS can get it done in a matter of seconds.'),
  ('Knights of the Narazim', 'Need to resolve a merge conflict? The Knights of the Narazim have your back. Nobody knows Git like these folks do.');
